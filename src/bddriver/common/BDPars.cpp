...
// clang-format off
  ...
  std::unordered_map<ConfigSomaID, std::vector<unsigned int>, EnumClassHash> BDPars::config_soma_mem_ = {
  ...
  std::unordered_map<ConfigSynapseID, std::vector<unsigned int>, EnumClassHash> BDPars::config_synapse_mem_ = {
    {bdpars::ConfigSynapseID::SYN_DISABLE , {75 , 76 , 12 , 11}} ,
    {bdpars::ConfigSynapseID::ADC_DISABLE , {67 , 68 , 4  , 3}}
  };

  std::unordered_map<DiffusorCutLocationId, std::vector<unsigned int>, EnumClassHash> BDPars::config_diff_cut_mem_ = {
