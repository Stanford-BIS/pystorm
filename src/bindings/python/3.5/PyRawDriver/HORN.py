...
DAC                 = dict()
DAC['DIFF_G']       = (8, "10110000", 176, 11, 1, 11, "DIFF_G DAC bias value")
DAC['SYN_INH']      = (7, "1011101" , 93 , 11, 1, 11, "SYN_INH DAC bias value")
DAC['SYN_PU']       = (7, "1011110" , 94 , 11, 1, 11, "SYN_PU DAC bias value")
DAC['UNUSED']       = (7, "1011111" , 95 , 11, 1, 11, "UNUSED ('ghost DAC')")
DAC['DIFF_R']       = (8, "10110001", 177, 11, 1, 11, "DIFF_R DAC bias value")
DAC['SOMA_OFFSET']  = (8, "10110010", 178, 11, 1, 11, "SOMA_OFFSET DAC bias value")
DAC['SYN_LK']       = (8, "10110011", 179, 11, 1, 11, "SYN_LK DAC bias value")
DAC['SYN_DC']       = (8, "10110100", 180, 11, 1, 11, "SYN_DC DAC bias value")
DAC['SYN_PD']       = (8, "10110101", 181, 11, 1, 11, "SYN_PD DAC bias value")
DAC['ADC_2']        = (8, "10110110", 182, 11, 1, 11, "ADC_BIAS_2 DAC bias value")
DAC['ADC_1']        = (8, "10110111", 183, 11, 1, 11, "ADC_BIAS_1 DAC bias value")
DAC['SOMA_REF']     = (8, "10111000", 184, 11, 1, 11, "SOMA_REF DAC bias value")
DAC['SYN_EXC']      = (8, "10111001", 185, 11, 1, 11, "SYN_EXC DAC bias value")
DELAY               = (
                      (7, "1000000" , 64 , 8 , 1, 8 , "FIFO:DCT delay line config"),
                      (7, "1000010" , 66 , 8 , 1, 8 , "FIFO:PG delay line config"),
                      (8, "10001110", 142, 8 , 1, 8 , "TAT 0 delay line config"),
                      (8, "10001111", 143, 8 , 1, 8 , "TAT 1 delay line config"),
                      (6, "100100"  , 36 , 8 , 1, 8 , "PAT delay line config"),
                      (7, "1001100" , 76 , 8 , 1, 8 , "MM delay line config"),
                      (7, "1001101" , 77 , 8 , 1, 8 , "AM delay line config")
)
...
PROG_TAT            = (
                      (7, "1000001" , 65 , 31, 4, 8 , "TAT 0 programming/diagnostic port"),
                      (7, "1000011" , 67 , 31, 4, 8 , "TAT 1 programming/diagnostic port")
)
RI                  = (1, "0"       , 0  , 20, 1, 20, "main tag input to FIFO")
TOGGLE_POST_FIFO    = (
                      (8, "10001010", 138, 2 , 1, 2 , "toggles data/dump traffic for FIFO tag class 0 output"),
                      (8, "10001011", 139, 2 , 1, 2 , "toggles data/dump traffic for FIFO tag class 1 output")
)
...
def __create_input_word__(horn_route, payload):
    ...
    :return: binary string representing the HORN word
    """
...
def CreateDACWord(dac_name, value):
    """
    :param dac_name:
    :param value:
    :return: binary string representing HORN word
    """
    return CreateInputWord(DAC[dac_name], value)
