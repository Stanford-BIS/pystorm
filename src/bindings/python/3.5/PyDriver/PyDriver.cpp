...
void bind_unknown_unknown_2(std::function< py::module &(std::string const &namespace_) > &M)
{
    ...
    // manually modified
		cl.def("SendTags", &Driver::SendTags, "Send a stream of tags\n\nC++: pystorm::bddriver::Driver::SendTags(unsigned int, const class std::vector<unsigned long, class std::allocator<unsigned long> > &, const class std::vector<unsigned int, class std::allocator<unsigned int> >, bool) --> void", py::arg("core_id"), py::arg("tags"), py::arg("times")={}, py::arg("flush")=true);
