...
void bind_unknown_unknown_2(std::function< py::module &(std::string const &namespace_) > &M)
{
    ...
    // manually added
		...
		cl.def("SetDACValue", [](pystorm::bddriver::Driver &o, unsigned int  const &a0, pystorm::bddriver::bdpars::BDHornEP  const &a1, unsigned int  const &a2) -> void { return o.SetDACValue(a0, a1, a2); }, "", py::arg("core_id"), py::arg("signal_id"), py::arg("value"));
		cl.def("SetDACValue", (void (pystorm::bddriver::Driver::*)(unsigned int, pystorm::bddriver::bdpars::BDHornEP, unsigned int, bool)) &pystorm::bddriver::Driver::SetDACValue, "Program DAC value\n\nC++: pystorm::bddriver::Driver::SetDACValue(unsigned int, pystorm::bddriver::bdpars::BDHornEP, unsigned int, bool) --> void", py::arg("core_id"), py::arg("signal_id"), py::arg("value"), py::arg("flush"));
        ...
        cl.def("GetMemAERAddr", &pystorm::bddriver::Driver::GetMemAERAddr, "Given flat xy_addr (y msb, x lsb) memory (16-neuron tile) address, get AER address", py::arg("xy_addr"));
        cl.def("GetSynAERAddr", &pystorm::bddriver::Driver::GetSynAERAddr, "Given flat xy_addr (y msb, x lsb) synapse address, get AER address", py::arg("xy_addr"));
    ...
    cl.def("DumpMemRange", &Driver::DumpMemRange, py::arg("core_id"), py::arg("mem_id"), py::arg("start"), py::arg("end"));
		...
		cl.def("SendTags", [](pystorm::bddriver::Driver &o, unsigned int  const &a0, const class std::vector<pystorm::bddriver::BDWord, class std::allocator<pystorm::bddriver::BDWord> > & a1, const class std::vector<unsigned int, class std::allocator<unsigned int> >  &a2) -> void { return o.SendTags(a0, a1, a2); }, "", py::arg("core_id"), py::arg("tags"), py::arg("times"));
		cl.def("SendTags", (void (pystorm::bddriver::Driver::*)(unsigned int, const class std::vector<unsigned long, class std::allocator<unsigned long> > &, const class std::vector<unsigned int, class std::allocator<unsigned int> >, bool)) &pystorm::bddriver::Driver::SendTags, "Send a stream of tags\n\nC++: pystorm::bddriver::Driver::SendTags(unsigned int, const class std::vector<unsigned long, class std::allocator<unsigned long> > &, const class std::vector<unsigned int, class std::allocator<unsigned int> >, bool) --> void", py::arg("core_id"), py::arg("tags"), py::arg("times"), py::arg("flush"));
