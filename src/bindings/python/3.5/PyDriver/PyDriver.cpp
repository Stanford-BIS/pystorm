...
void bind_unknown_unknown_2(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // pystorm::bddriver::Driver file:Driver.h line:96
        ...
        cl.def("GetMemAERAddr", &pystorm::bddriver::Driver::GetMemAERAddr, "Given flat xy_addr (y msb, x lsb) memory (16-neuron tile) address, get AER address", pybind11::arg("xy_addr"));
        cl.def("GetSynAERAddr", &pystorm::bddriver::Driver::GetSynAERAddr, "Given flat xy_addr (y msb, x lsb) synapse address, get AER address", pybind11::arg("xy_addr"));
        cl.def("GetSomaXYAddr", &pystorm::bddriver::Driver::GetSomaXYAddr, "Given AER synapse address, get flat xy_addr (y msb, x lsb)", pybind11::arg("aer_addr"));
