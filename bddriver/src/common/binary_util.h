...
inline uint64_t MaxVal(unsigned int width) {
  uint64_t one = 1;
  return (one << width) - 1;
}
...
// Unpack64
typedef void (*Unpack64_type)(uint64_t val, const unsigned int *widths, uint64_t *unpacked_vals,
...
// Unpack64to32
typedef void (*Unpack64to32_type)(uint64_t val, const unsigned int *widths, uint32_t *unpacked_vals,
                                  unsigned int num_fields);
...
// Unpack32
typedef void (*Unpack32_type)(uint32_t val, const unsigned int *widths, uint32_t *unpacked_vals,
                              unsigned int num_fields);
